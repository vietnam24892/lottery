  ...
  setTimeout(() => {
    ...
    fetch("/api/webapi/GetUserInfo")
      ...
      .then((data) => {
        ...
        $(".num span").text(`${formatter.format(data.data.money_user)} `);
      });
    $(".Loading").fadeOut(0);
  }, 1000);
});
...
function totalMoney() {
  ...
  $(".foot .right span:eq(1)").text(formatter.format(total));
}
...
$(".foot .right").click(function (e) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $(".total-box .num span").text(formatter.format(response.money));
    ...
    return (htmls += `
        ...
        list_orders.time
                                ...
                                <div data-v-a9660e98="" class="money">
                                        ${list_orders.status == 1
        ? '<span data-v-a9660e98="" class="success" style="font-size: 14px;"> + ' +
        formatter.format(list_orders.get) +
        " </span>"
        : list_orders.status == 2
          ? '<span data-v-a9660e98="" class="fail" style="font-size: 14px;"> - ' +
          formatter.format(list_orders.money) +
          "</span>"
          : ""
      }
                                </div>
                            ...
                            <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                ...
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                    ...
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                        ...
                                        <div data-v-a9660e98="">${formatter.format(list_orders.money + list_orders.fee)
      }</div>
                                    </div>
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                        <div data-v-a9660e98="">Số lượng mua</div>
                                        <div data-v-a9660e98="">${formatter.format(list_orders.amount)
      }</div>
                                    </div>
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                        <div data-v-a9660e98="">Số tiền sau thuế</div>
                                        <div data-v-a9660e98="" class="red">${formatter.format(list_orders.money)
      }</div>
                                    </div>
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                        <div data-v-a9660e98="">Thuế</div>
                                        <div data-v-a9660e98="">${formatter.format(list_orders.fee)
      }</div>
                                    </div>
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
        ...
        : list_orders.result == 5
          ...
          : list_orders.result % 2 == 0
            ...
            : "Xanh"
                                        ...
                                        <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.amount < 5 ? "Nhỏ" : "Lớn"
      }</div>
                                    </div>
                                </div>
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle ">
