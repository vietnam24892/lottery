...
function GetMyEmerdList(list_orders) {
    ...
    let result = list_orders.map((list_order) => {
        console.log(JSON.stringify(list_order));
        return (htmls += `
        <div data-v-42f27458="" issuenumber="${list_order.id_product}" addtime="${timerJoin(list_order.time)}" rowid="1" class="hb">
                <div data-v-03b808c2="" class="item c-row">
                    <div data-v-03b808c2="" class="c-row c-row-between c-row-middle info">
                        ...
                        <div data-v-03b808c2="" class="money ${(list_order.status == 0) ? 'd-none' : ''}">
                            <!---->
                            <span data-v-03b808c2="" class="${(list_order.status == 1) ? 'success' : 'fail'}"> ${(list_order.status == 1) ? '+' : '-'}${(list_order.status == 1) ? formatter.format(list_order.get) : formatter.format(list_order.price)} </span>
                        </div>
                    </div>
                </div>
                <!---->
                ...
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                    ...
                    <div data-v-42f27458="">${formatter.format(list_order.money)}</div>
                </div>
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                ...
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                    ...
                    <div data-v-42f27458="" class="red">${formatter.format(list_order.price)}</div>
                </div>
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                    <div data-v-42f27458="">Thuế</div>
                    <div data-v-42f27458="">${formatter.format(list_order.fee)}</div>
                </div>
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                ...
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                    ...
                    <div data-v-42f27458="" class="${(list_order.status == 1) ? 'green' : 'red'}" style="display: ${(list_order.status == 0) ? 'none' : ''};">${(list_order.status == 1) ? 'Thành công' : 'Thất bại'}</div>
                    <!---->
                </div>
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                    <div data-v-42f27458="">Thắng thua</div>
                    <div data-v-42f27458="" class="${(list_order.status == 1) ? 'green' : 'red'}" style="display: ${(list_order.status == 0) ? 'none' : ''};">${(list_order.status == 1) ? '+' : '-'} ${(list_order.status == 1) ? formatter.format(list_order.get) : formatter.format(list_order.money)}</div>
                    <!---->
                </div>
                <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
...
async function showMeJoin() {
    ...
    setTimeout(() => {
        $('#list_order .hb').click(function (e) {
            e.preventDefault();
