...
function showResultNow(data) {
    ...
    $(".round-num #total_r").text(formatter.format(total));
}
...
function result() {
    ...
    $("#total").html(formatter.format(result));
}
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == true) {
                let num = Number(response.money)
                .toLocaleString('en');              
                $('#money_show').text(num + '.00 ₫ ');
                showMeJoin();
            }
        }
    });
      ...
      <div data-v-42f27458="" issuenumber="${data.id_product}" addtime="${timerJoin(data.time)}" rowid="1" class="hb">
          <div data-v-42f27458="" class="item c-row">
              <div data-v-42f27458="" class="c-row c-row-between info">
                  ...
                  <div data-v-42f27458="" class="money" style="display: ${(data.status == 0) ? 'none' : ''}">
                      <span data-v-42f27458="" class="${(data.status == 1) ? 'success' : 'fail'}"> ${(data.status == 1) ? '+' : '-'} ${(data.status == 1) ? formatter.format(data.get) : formatter.format(data.money)} </span>
                      <!---->
                  </div>
              </div>
          </div>
          <div data-v-42f27458="" class="details display-none">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="">${formatter.format(data.money)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="red">${formatter.format(data.price)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Thuế</div>
                  <div data-v-42f27458="">${formatter.format(data.fee)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="${(data.status == 1) ? 'green' : 'red'}" style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? '+' : '-'} ${(data.status == 1) ? formatter.format(data.get) : formatter.format(data.price)}</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
