...
const initWebRouter = (app) => {
    ...
    router.post('/home/configs/get', homeController.configGet); // get info account
    ...
    router.get('/admin/manager/configs', adminController.middlewareAdminController, adminController.configs); // get info config
    ...
    router.post('/admin/manager/configs/get', adminController.middlewareAdminController, adminController.configGet); // get info account
    router.post('/admin/manager/configs/updateConfigs', adminController.middlewareAdminController, adminController.configsUpdate); // get info account
    ...
    router.post('/api/webapi/admin/member/changepass', adminController.middlewareAdminController, adminController.changePassword); // get info account
    router.post('/api/webapi/admin/member/adminrecharge', adminController.middlewareAdminController, adminController.Adminrecharge); // get info account
